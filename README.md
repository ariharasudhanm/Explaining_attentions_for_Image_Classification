...
<div align="center">
  ...
  <h3 align="center">Explaining_attentions_for_Image_classification (Kaggle Competetion) </h3>
...
<p align="center" width="75%">
       <img width="75%" src="https://github.com/ariharasudhanm/Image_classification_Kaggle_Competition/blob/main/app.gif">
     </p>
...
Trained model is available in the [model](https://huggingface.co/Ariharasudhan/efficientnet_bfour/tree/main) in the hugging face page.
...
1. You can pull the docker image to your local machine by using this command `docker pull ariharasudhan/food-classifier` in a command terminal or you can find it in the [docker repo](https://hub.docker.com/r/ariharasudhan/food-classifier/tags), by default it will pull the latest image so no issues with image versions.
